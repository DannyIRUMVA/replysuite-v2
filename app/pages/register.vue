  ...
  <div class="min-h-screen flex items-center justify-center px-4 bg-background relative overflow-hidden">
    ...
    <div class="w-full max-w-md">
      ...
      <div class="glass-card p-10 border-white/5 shadow-2xl !bg-[#0f0f0f]">
        ...
        <div v-if="successMsg"
          class="bg-primary/10 border border-primary/20 p-6 rounded-24 mb-8 text-center animate-in fade-in zoom-in duration-300">
          ...
          <NuxtLink to="/login" class="text-xs text-primary font-bold tracking-wider hover:underline">go to login
          </NuxtLink>
        </div>
        ...
        <form v-else @submit.prevent="handleSignup" class="space-y-6">
          ...
          <div class="flex flex-col gap-4">
            ...
            <button type="button" @click="navigateTo('/login')"
              class="w-full text-sm text-gray-500 hover:text-white transition-colors">
