      ...
      <main class="flex-1 glass-card p-10 border-foreground/10 bg-background min-h-[600px] relative overflow-hidden">
        ...
        <div class="animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div class="space-y-10">
            <div class="p-8 border border-foreground/10 rounded-[32px] bg-foreground/[0.01]">
              <h4 class="text-sm font-black uppercase tracking-widest text-foreground/60 mb-6">Security</h4>
              <div class="flex items-center justify-between">
                <div>
                  <p class="font-bold text-foreground">Email Address</p>
                  <p class="text-sm text-foreground/50">{{ user?.email }}</p>
                </div>
              ...
              <div class="flex items-center justify-between">
                <div>
                  <p class="font-bold text-foreground">Password</p>
                  <p class="text-sm text-foreground/50">Last changed 2 months ago.</p>
                </div>
            ...
            <div class="p-8 border border-red-500/10 rounded-[32px] bg-red-500/[0.02]">
              ...
              <div class="flex items-center justify-between">
                <div class="max-w-md">
                  <p class="font-bold text-foreground">Delete Account</p>
                  <p class="text-sm text-foreground/50 mt-1">Permanently delete your account and all associated AI agents.
