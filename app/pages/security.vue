  ...
  <div class="relative min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-6 py-20">
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-32">
        <div v-for="f in features" :key="f.title" class="glass-card p-10 border-white/5 hover:border-primary/20 transition-all group">
          ...
          <h3 class="text-lg font-bold text-white mb-2 tracking-tight">{{ f.title }}</h3>
          <p class="text-gray-500 text-sm leading-relaxed font-medium">{{ f.desc }}</p>
        </div>
      </div>
      ...
      <main class="max-w-4xl mx-auto prose prose-invert prose-primary prose-lg">
        <section class="mb-24">
          ...
          <ul class="space-y-4 not-prose">
            <li v-for="item in ['Automated point-in-time recovery (PITR)', 'SOC 2 compliant data centers', 'Multi-region redundancy', 'Real-time threat detection']" :key="item" class="flex items-center gap-4 text-gray-400 font-medium">
        ...
        <section class="mb-24">
          ...
          <div class="bg-primary/5 border border-primary/20 p-8 rounded-[32px] my-10">
             ...
             <p class="text-white font-medium mb-0 leading-relaxed text-base">
        ...
        <div class="mt-40 p-16 rounded-[48px] bg-white/[0.02] border border-white/5 text-center">
          ...
          <p class="text-gray-400 mb-10 font-medium">Request our detailed security whitepaper or VDP policy.</p>
