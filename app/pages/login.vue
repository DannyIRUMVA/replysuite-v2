...
import { Zap, Loader2, Sparkles } from 'lucide-vue-next'
    ...
    <div class="hidden lg:flex lg:w-[45%] xl:w-[40%] relative flex-col justify-between p-12 overflow-hidden border-r border-foreground/5 bg-background-card">
      ...
      <div class="relative z-10 space-y-8">
        ...
        <div class="flex flex-col gap-6 pt-10">
          <div v-for="feat in [
            { title: 'Train on your content', desc: 'Use your website, PDFs, and custom text.' },
            { title: 'Deploy faster', desc: 'Launch on your site and expand when needed.' }
    ...
    <div class="flex-1 flex flex-col justify-center items-center p-6 md:p-12 lg:p-20 relative bg-background">
      ...
      <div class="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div class="mb-10 text-center lg:text-left">
          <h1 class="text-4xl font-bold tracking-tight mb-3 text-foreground">Sign in</h1>
          <p class="text-foreground/50 font-medium leading-relaxed">Open your dashboard and continue setup.</p>
        </div>
        ...
        <div>
          ...
          <form @submit.prevent="handleLogin" class="space-y-8">
            ...
            <div class="space-y-2">
              ...
              <input v-model="password" type="password" required class="w-full bg-foreground/[0.02] border border-foreground/5 rounded-2xl px-6 py-4 focus:outline-none focus:border-primary/50 transition-all text-foreground placeholder:text-foreground/20 text-sm" placeholder="••••••••" />
            </div>
