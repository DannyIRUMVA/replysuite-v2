...
<template>
  <div class="relative">
      ...
      <section id="mission" class="max-w-7xl mx-auto px-6 py-32 border-t border-foreground/10">
        <div class="bg-foreground/[0.02] p-16 md:p-24 rounded-[48px] border border-foreground/10 relative overflow-hidden group">
          ...
          <div class="grid lg:grid-cols-2 gap-20 items-center relative z-10">
            ...
            <div class="relative flex justify-center lg:justify-end">
              <div class="w-72 h-72 rounded-[64px] bg-gradient-to-br from-primary/30 to-transparent p-1 group-hover:rotate-6 transition-transform duration-700">
                <div class="w-full h-full rounded-[63px] bg-background flex items-center justify-center p-12">
                   <Users class="w-24 h-24 text-primary group-hover:scale-110 transition-transform shadow-2xl shadow-primary/20" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="grid lg:grid-cols-2 gap-20 items-center">
          <div class="order-2 lg:order-1">
             <div class="grid grid-cols-2 gap-4">
                <div v-for="i in 4" :key="i" class="h-40 rounded-3xl bg-foreground/[0.02] border border-foreground/10 overflow-hidden group">
      ...
      <section class="max-w-5xl mx-auto px-6 py-40 text-center">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-8">
           ...
           <NuxtLink to="/pricing" class="w-full sm:w-auto border border-foreground/10 px-12 py-5 rounded-full hover:bg-foreground/5 transition-colors text-xl font-bold">View Pricing</NuxtLink>
        </div>
      </section>
  </div>
</template>
